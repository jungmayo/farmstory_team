  ...
  <main>
    ...
    <section class="mainSection">
      <aside class="mainAside">
        ...
        <ul class="asideList">
          <li><a href="/FarmStoryJSP/article/list.do?group=croptalk&cate=story"><img src="../images/sub_cate3_lnb1_ov.png" alt=""></a></li>
      ...
      <article class="mainArticle">
        <nav class="articleNav">
          <img src="../images/sub_nav_tit_cate3_tit1.png" alt="event">
          <p><img src="../images/sub_page_nav_ico.gif" alt="navIcon"> HOME > 농작물이야기 > <strong>농작물이야기</strong></p>
        </nav>
