...
window.onload = function(){
	...
	const findIdForm = document.getElementsByTagName('form')[0];
	...
	const resultEmail = document.getElementsByClassName('resultEmail')[0];
		...
		btnauth.addEventListener('click' , function(){
			const authnum = findIdForm.authnum.value;
...
<body>
    ...
    <main>
        <section>
            <form action="/FarmStoryJSP/user/findid.do" id="findIdForm" method = "POST">
                <h2>아이디 찾기</h2>
                <table>
                    <tbody>
                        <tr>
                            <th><label for="username">이름</label></th>
                            <td><input type="text" placeholder="이름 입력" name = "name" required autofocus id="username"></td>
                        </tr>
                        <tr>
                            <th>이메일</th>
                            <td>
