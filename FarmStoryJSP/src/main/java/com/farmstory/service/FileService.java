...
import com.farmstory.dao.FileDao;
...
public enum FileService {
	...
	private FileDao dao = FileDao.getInstence();
	...
	public void deleteFiles(HttpServletRequest req, String ano) {

		List<FileDto> list = dao.deleteFiles(ano);
